...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/gupeng/FlutterFrameWorkTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gupeng' => '1690105087@qq.com' }
  s.source           = { :git => 'https://github.com/gupeng/FlutterFrameWorkTest.git', :tag => s.version.to_s }
